    ...
    <nav className="fixed top-0 w-full z-50 backdrop-blur-md transition-colors duration-300"
      ...
      <div className="max-w-7xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-8 text-sm font-medium items-center">
          ...
          <div>
            <Link to="/smart-aes" className="px-5 py-2.5 rounded-full text-xs font-semibold tracking-wider uppercase bg-brand/10 border border-brand/30 hover:bg-brand/20 text-brand transition-all duration-300">
              Live Demo
            </Link>
          </div>
        </div>
