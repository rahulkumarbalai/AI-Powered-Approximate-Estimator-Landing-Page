    ...
    <section id="impact" className="py-24 px-6 relative bg-gradient-to-b from-transparent to-[#050914] border-t border-white/5">
      <div className="max-w-6xl mx-auto w-full text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="glass-card p-8 rounded-3xl border-brand/20 glow-cyan">
          ...
          <div className="glass-card p-8 rounded-3xl border-success/20 glow-emerald">
          ...
          <div className="glass-card p-8 rounded-3xl border-ai/20 glow-purple">
