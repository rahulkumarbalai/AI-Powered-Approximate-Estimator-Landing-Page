  ...
  return (
    <section id="pipeline" ref={sectionRef} className="min-h-screen py-24 px-6 relative flex flex-col justify-center">
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div id="pipeline-box" className="relative w-full bg-darkSurface/50 border border-white/5 rounded-3xl p-8 lg:p-12 overflow-hidden pipeline-container">
          
          <svg ref={svgRef} id="pipeline-svg" className="absolute inset-0 w-full h-full pointer-events-none z-0"></svg>
          ...
          <div className="flex flex-col md:flex-row items-stretch justify-between relative z-10 gap-6">
            ...
            <div ref={el => nodesRef.current.query = el} className="flex-1 solid-card p-6 rounded-2xl border-white/10 pipeline-step flex flex-col justify-center relative z-10">
              ...
              <div className="space-y-3 w-full">
                <button id="query-exact" className="query-btn w-full text-[10px] py-2 px-2 rounded-lg bg-white/5 hover:bg-brand/20 border border-white/10 hover:border-brand transition-all text-left flex items-center justify-between group">
                  <span className="truncate">"Cement mortar 1:1"</span>
                ...
                <button id="query-semantic" className="query-btn w-full text-[10px] py-2 px-2 rounded-lg bg-white/5 hover:bg-ai/20 border border-white/10 hover:border-ai transition-all text-left flex items-center justify-between group">
                  <span className="truncate">"Digging for foundation"</span>
                ...
                <button id="query-keyword" className="query-btn w-full text-[10px] py-2 px-2 rounded-lg bg-white/5 hover:bg-brandLight/20 border border-white/10 hover:border-brandLight transition-all text-left flex items-center justify-between group">
                  <span className="truncate">"Trench 1.5m deep"</span>
            ...
            <div className="flex-[1.5] flex flex-col gap-4">
              ...
              <div ref={el => nodesRef.current.fastapi = el} className="solid-card p-6 rounded-2xl border-ai/30 bg-ai/5 pipeline-step text-center flex-1 pipeline-node transition-opacity duration-300 relative z-10 flex flex-col justify-center">
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px] font-mono">
                  ...
                  <div ref={el => nodesRef.current.bm25 = el} className="bg-ai/10 p-2 rounded text-ai-light transition-opacity duration-300 pipeline-node relative z-10">BM25 Keyword<br/>(Top 20)</div>
                </div>
              </div>
            </div>
            ...
            <div ref={el => nodesRef.current.cross = el} className="flex-1 solid-card p-6 rounded-2xl border-ai/40 glow-purple pipeline-step text-center flex flex-col justify-center relative overflow-hidden pipeline-node transition-opacity duration-300 z-10">
              ...
              <div className="relative z-10">
                ...
                <p className="text-[10px] text-slate-300 font-mono">BAAI/bge-reranker-base<br/>Merges & Scores</p>
              </div>
            </div>
