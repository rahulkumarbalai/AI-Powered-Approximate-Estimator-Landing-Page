    ...
    <section id="architecture" className="min-h-screen py-24 px-6 relative flex flex-col justify-center">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="relative w-full max-w-5xl mx-auto h-[600px] flex items-center justify-center architecture-container">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-[15%] w-64 solid-card p-6 rounded-2xl arch-node z-10 border-[var(--border-color)]">
            <div className="flex items-center space-x-3 mb-4">
            ...
            <ul className="text-xs text-slate-400 space-y-2 font-mono">
              <li><span className="text-slate-400 mr-2">▶</span>Node.js</li>
              <li><span className="text-slate-400 mr-2">▶</span>Express.js</li>
              <li><span className="text-slate-400 mr-2">▶</span>exceljs & xlsx</li>
              <li><span className="text-slate-400 mr-2">▶</span>JWT Verification</li>
            </ul>
          </div>
