    ...
    <div className="min-h-screen relative overflow-hidden flex flex-col">
      ...
      <main className="flex-1 relative z-10 flex flex-col items-center justify-center p-6 mt-16 pb-20">
        <div className="demo-content w-full max-w-5xl flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl text-center mb-10">
            Explore our platform in action. Currently running on serverless functions.
            (AI search pipeline coming soon!)
          </p>
          ...
          >
            ...
            <div className="mt-6 flex flex-col md:flex-row items-center justify-between gap-4 px-2 text-center md:text-left">
              <div>
                ...
                <p className="text-slate-400">Click to launch the fully functional web application.</p>
              </div>
